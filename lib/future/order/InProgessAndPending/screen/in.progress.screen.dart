import 'package:adms/future/order/InProgessAndPending/controller/in.progress.order.controller.dart';
...
class BuildInProgressOrderItems extends GetView<InProgressOrderController> {
  const BuildInProgressOrderItems({Key? key}) : super(key: key);
