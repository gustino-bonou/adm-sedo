import 'package:adms/future/order/InProgessAndPending/controller/pending.controller.dart';
...
class BuildPendingOrderItems extends GetView<PendingOrderController> {
  const BuildPendingOrderItems({Key? key}) : super(key: key);
