...
class InProgressOrderController extends GetxController {
  static InProgressOrderController get instance => Get.find();

  final AuthRepository authRepository;

  InProgressOrderController({required this.authRepository});
