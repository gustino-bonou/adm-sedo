...
class AvailableDeliveryPersonController extends GetxController {
  static AvailableDeliveryPersonController get instance => Get.find();

  final AuthRepository authRepository;

  AvailableDeliveryPersonController({required this.authRepository});
